        ...
        for (let i = 0; i < NUM_ROWS; i++) {
            ...
            rows.push(
                <tr key={i} className="hover:bg-gray-700 transition-colors">
                    <td className="p-1 font-mono text-xs text-purple-300 sticky left-0 bg-gray-800">${rowAddress.toString(16).padStart(4, '0').toUpperCase()}</td>{byteCells}<td className="p-1 border-l border-gray-600"></td>
                    {/* Separator */}
                    {asciiChars}
                </tr>
            );
