...
const RegisterDisplay: React.FC<{ name: string; value: number; hex?: boolean }> = ({ name, value, hex = true }) => (
  <div className="flex justify-between items-center p-2 bg-gray-700 rounded">
    ...
    <span className="font-mono text-m text-green-300">
...
const CpuRegistersView: React.FC<CpuRegistersViewProps> = ({ cpu }) => {
  return (
    <div className="bg-gray-800 p-4 rounded-lg shadow-md">
      <h2 className="text-lg font-semibold mb-3 text-gray-200">CPU Registers <div className="text-sm text-gray-400"> Cycles: {cpu.cycles} </div>
      </h2>
      <div className="grid grid-cols-3 gap-3">
        ...
        <RegisterDisplay name="SP" value={cpu.SP} hex={true} />
